		...
		<link rel="icon" type="image/png" sizes="512x512" href="{{ asset('images/fav-icon/android-chrome-512x512.png') }}">
		<link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('images/fav-icon/android-chrome-192x192.png') }}">
		...
		<!-- Theme-Color css -->
		<link rel="stylesheet" id="jssDefault" href="{{ asset('css/custom/color-2.css') }}">
